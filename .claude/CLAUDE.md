...
config/arango-openapi-community.json  ← Active spec (generated: official minus Hot Backups + rotateEncryptionAtRestKey)
...
1. `arango-openapi-community.json` paths → 246 HTTP operations → grouped by tag into category tools
   (`arango-openapi.json` = upstream official, READ-ONLY. Use `--enterprise` flag to switch back.
    Regenerate community spec: `node scripts/gen-community-spec.mjs`)
...
| community spec is generated | Need to change which operations are active | Regenerate arango-openapi-community.json by filtering arango-openapi.json (remove enterprise tags) | NEVER hand-edit the community file — it is a generated artifact |
...
| NEVER hand-edit arango-openapi-community.json | It is generated from arango-openapi.json — edits will be lost on next regeneration |
...
| config/arango-openapi.json | ArangoDB API spec (official, READ-ONLY, DO NOT MODIFY) |
| config/arango-openapi-community.json | **Active spec** used by dispatch (generated by scripts/gen-community-spec.mjs) |
| scripts/gen-community-spec.mjs | Regenerate community spec from official spec |
| docs/arangodb-editions.md | Enterprise vs Community feature differences |
